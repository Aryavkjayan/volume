...
import 'package:volume/onbord2.dart';

class Onbord1Screen extends StatefulWidget {
  const Onbord1Screen({
    Key? key,
  }) : super(key: key);

  @override
  State<Onbord1Screen> createState() => _Onbord1ScreenState();
}

class _Onbord1ScreenState extends State<Onbord1Screen> {
  @override
